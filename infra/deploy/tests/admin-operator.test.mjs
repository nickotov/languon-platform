...
const config = [
    ...
    'ACCOUNT_DELETION_JOURNAL_PREFIX=deletions',
    'ACCOUNT_DELETION_JOURNAL_NAMESPACE=test-stage',
    'ACCOUNT_DELETION_JOURNAL_REGION=us-east-1',
    'ACCOUNT_DELETION_JOURNAL_ENCRYPTION_KEY_BASE64=AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',
    'ACCOUNT_DELETION_JOURNAL_WRITER_ACCESS_KEY_ID=writer-test',
    'ACCOUNT_DELETION_JOURNAL_WRITER_SECRET_ACCESS_KEY=writer-test-secret',
    'ACCOUNT_DELETION_JOURNAL_READER_ACCESS_KEY_ID=reader-test',
    'ACCOUNT_DELETION_JOURNAL_READER_SECRET_ACCESS_KEY=reader-test-secret',
